...
class KnowledgeArticleForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'file': 'Attachment (PPT, PDF, Word, Excel, Image)'}
...
class TicketForm(forms.ModelForm):
    ...
    query_relevance = forms.CharField(required=False, widget=forms.Select(attrs={'class': 'form-control', 'id': 'query-relevance-select'}))
...
class TicketMessageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {'body': forms.Textarea(attrs={'class': 'form-control', 'rows': 3, 'placeholder': 'Type your reply here...'})}
