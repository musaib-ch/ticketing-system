...
server {
    ...
    location / {
        ...
        # Cloudflare always uses HTTPS with visitors; tell Django the upstream
        # scheme is https so SECURE_PROXY_SSL_HEADER works correctly.
        proxy_set_header X-Forwarded-Proto https;
        # Forward the real visitor IP that Cloudflare injects.
